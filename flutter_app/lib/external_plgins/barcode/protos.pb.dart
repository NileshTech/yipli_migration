...
class AndroidConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('AndroidConfiguration', createEmptyInstance: create)
        ..a<$core.double>(1, 'aspectTolerance', $pb.PbFieldType.OD,
...
class Configuration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Configuration',
    ...
    ..m<$core.String, $core.String>(1, 'strings',
        entryClassName: 'Configuration.StringsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OS)
    ..pc<BarcodeFormat>(2, 'restrictFormat', $pb.PbFieldType.PE,
    ...
    ..aOM<AndroidConfiguration>(4, 'android',
...
class ScanResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('ScanResult', createEmptyInstance: create)
        ..e<ResultType>(1, 'type', $pb.PbFieldType.OE,
        ...
        ..e<BarcodeFormat>(3, 'format', $pb.PbFieldType.OE,
