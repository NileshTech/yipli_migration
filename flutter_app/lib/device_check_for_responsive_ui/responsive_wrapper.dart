...
class _ResponsiveWrapperState extends State<ResponsiveWrapper>
  ...
  double? getScreenWidth() {
    ...
    if (activeBreakpointSegment!.responsiveBreakpoint!.breakpoint == 0)
      return 0;
  ...
  Widget build(BuildContext context) {
    return (screenWidth ==
        ...
        ? (widget.backgroundColor as Widget? ??
            Container(
...
class ResponsiveWrapperData {
  ...
  static ResponsiveWrapperData fromResponsiveWrapper(
    ...
    return ResponsiveWrapperData(
      ...
      isPhone:
          state.activeBreakpointSegment!.responsiveBreakpoint!.name == PHONE,
      isTablet:
